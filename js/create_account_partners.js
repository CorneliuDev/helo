...
form.addEventListener("submit", (e) => {
    ...
    const idnoString = document.getElementById("idno").value;
    const emailString = document.getElementById("email").value;
    const confirmationString= document.getElementById("confirmation").value;

    if (idnoString === "") {
        e.preventDefault();
        document.getElementById("idno").setCustomValidity("Acest câmp este obligatoriu!");
        return false;
    } else if (emailString === "") {
        e.preventDefault();
        document.getElementById("email").setCustomValidity("Acest câmp este obligatoriu!");
        return false;
    } else if (confirmationString === "") {
        e.preventDefault();
        document.getElementById("confirmation").setCustomValidity("Acest câmp este obligatoriu!");
        return false;
    } else if (passwordString === "") {
        e.preventDefault();
        document.getElementById("pass").setCustomValidity("Acest câmp este obligatoriu!");
        return false;
    } else if (confirmPasswordString === "") {
        e.preventDefault();
        document.getElementById("confirm-pass").setCustomValidity("Acest câmp este obligatoriu!");
        return false;
